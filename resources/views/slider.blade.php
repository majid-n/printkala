	...
	<div class="tp-banner">
		<ul>	<!-- SLIDE  -->
			<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
				<!-- MAIN IMAGE -->
				<img src="{{ asset('img/slider/slidebg1.jpg') }}" alt="slidebg1" data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
				<!-- LAYERS -->
				...
				<div class="tp-caption customin customout"
					...
					data-endspeed="500"
					data-endeasing="Power4.easeIn"
					style="z-index: 3"><img src="{{ asset('img/slider/woman.png') }}" alt="">
				</div>
				...
				<div class="tp-caption skewfromrightshort customout"
					...
					data-endeasing="Power4.easeIn"
					data-captionhidden="on"
					style="z-index: 9"><img src="{{ asset('img/slider/graph.png') }}" alt="" data-ww="52" data-hh="44">
				</div>
				...
				<div class="tp-caption customin customout"
					...
					data-endeasing="Power4.easeIn"
					data-captionhidden="on"
					style="z-index: 16"><img src="{{ asset('img/slider/star.png') }}" alt="" data-ww="20" data-hh="20">
				</div>
				...
				<div class="tp-caption customin customout"
					...
					data-endeasing="Power4.easeIn"
					data-captionhidden="on"
					style="z-index: 17"><img src="{{ asset('img/slider/star.png') }}" alt="" data-ww="20" data-hh="20">
				</div>
				...
				<div class="tp-caption customin customout"
					...
					data-endeasing="Power4.easeIn"
					data-captionhidden="on"
					style="z-index: 18"><img src="{{ asset('img/slider/star.png') }}" alt="" data-ww="20" data-hh="20">
				</div>
				...
				<div class="tp-caption customin customout"
					...
					data-endeasing="Power4.easeIn"
					data-captionhidden="on"
					style="z-index: 19"><img src="{{ asset('img/slider/star.png') }}" alt="" data-ww="20" data-hh="20">
				</div>
				...
				<div class="tp-caption customin customout"
					...
					data-endeasing="Power4.easeIn"
					data-captionhidden="on"
					style="z-index: 20"><img src="{{ asset('img/slider/star.png') }}" alt="" data-ww="20" data-hh="20">
				</div>
			...
			<li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
				<!-- MAIN IMAGE -->
				<img src="{{ asset('img/slider/darkblurbg.jpg') }}"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
				<!-- LAYERS -->
				...
				<div class="tp-caption customin"
					...
					data-endspeed="300"
					style="z-index: 2"><img src="{{ asset('img/slider/macbook2.png') }}" alt="">
				</div>
				...
				<div class="tp-caption customin"
					...
					data-easing="Power3.easeInOut"
					data-endspeed="300"
					style="z-index: 3"><img src="{{ asset('img/slider/imac1.png') }}" alt="">
				</div>
				...
				<div class="tp-caption customin"
					...
					data-easing="Power3.easeInOut"
					data-endspeed="300"
					style="z-index: 4"><img src="{{ asset('img/slider/lupe_macbook.png') }}" alt="">
				</div>
				...
				<div class="tp-caption customin"
					...
					data-easing="Power3.easeInOut"
					data-endspeed="300"
					style="z-index: 5"><img src="{{ asset('img/slider/lupe_imac.png') }}" alt="">
				</div>
